...
<form method="POST" action="pgRedirect.php?">
  <div id="form-main-container">
    <div id="form-area">
      ...
      <div class="col-12"> 
      <fieldset class="form-group">
      <label class="form-label" for="TXN_AMOUNT">Transaction Amount (RM)</label>
      ...
      <div class="col-12"> 
      <fieldset class="form-group">
      <label class="form-label" for="bname"><b>Shop Name</b></label>
      ...
      <a href="order_confirmation.html" button class="btn btn-cancel " style="text-decoration:none;" type="submit">Pay</button>
      </div></div></div></div>
  </div>
</form>
