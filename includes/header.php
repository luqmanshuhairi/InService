...
<div class="header">
  <div class="shimmer">
  <b style="font-size: 30px; line-height: 30px;"><span class="material-icons">sailing</span>&ensp;InService</b>
  </div>
</div>
...
<nav class="navi">
  <ul style="margin-top: 0%; padding: 0; list-style-type: none;">
    ...
    <li id="search" onclick="location.replace('search_items.php')"><span class="material-icons md-48 md-light">search</span></li>
    
    <li id="store" onclick="location.replace('item_purchased.php')"><span class="material-icons md-48 md-light">local_library</span></li>
    ...
    <li id="contact" onclick="location.replace('contact_form.html')"><span class="material-icons md-48 md-light">help</span></li>
