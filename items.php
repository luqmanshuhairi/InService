...
<?php 
    ...
    if(!isset($_SESSION["CUS_ID"]))
    {
        ...
        {
            echo "<p style='color: red; background-color: white; font-size: large; width: 150px'>No Item found  :(</p>";
        }
    ...
    else
    {
        ...
        if($res2->num_rows>0)
        {
            ...
            while($rows2=$res2->fetch_assoc())
            {
                ...
                <div class='card'>
                    ...
                    <p>{$rows2['author']}</p>
                    <p>{$rows2['keywords']}</p>
                    <a href='cust_item_det.php?id={$rows2["bid"]}'><button class='custom-btn btn'>View Item</button></a>
                    </div>
                </div>
        ...
        {
            echo "<p style='color: red; background-color: white; font-size: large; width: 350px'>You did'nt purchase any item in {$rows1['cat_name']}  :(</p>";
        }
        ...
        if($res3->num_rows>0)
        {
            ...
            while($rows3=$res3->fetch_assoc())
            {
                ...
                <div class='card'>
                    ...
                    <a href='cust_item_det.php?id={$rows3['bid']}'><button class='custom-btn btn'>View Item</button></a>
                </div>
                </div>            
                ";
            }
        ...
        {
            echo "<p style='color: red; background-color: white; font-size: large; width: 150px'>No Items found  :(</p>";
        }
    }
    ?>
...
<script>
    ...
    consoleText2(['Available items...', 'Available items...', 'Available items...'], 'text',['rgb(255, 0, 102)','rgb(92, 214, 92)','rgb(191, 128, 255)']);
...
<script>
    ...
    consoleText(['Item Purchased ...', 'Item Purchased...', 'Item Purchased...'], 'text2',['rgb(255, 0, 102)','rgb(92, 214, 92)','rgb(191, 128, 255)']);
