...
<div style="margin-right:10%">
    ...
    <select name="searchby">
          ...
          <option value="book.author">Shop</option>
...
<?php
    if (isset($_SESSION["CUS_ID"])) 
    {
        ...
        if($res2->num_rows>0)
        {
            ...
            while($rows2=$res2->fetch_assoc())
            {
                ...
                <div class='card'>
                    ...
                    <br><br><br>
                    <a href='cust_item_det.php?id={$rows2["bid"]}'><button class='custom-btn btn'>View Items</button></a>
                    </div>
                </div>
        ...
        {
            echo "<p style='color: red; background-color: white; font-size: large; width: 255px'>You did'nt purchase any item  :(</p>";
        }
        ...
        if($res3->num_rows>0)
        {
            ...
            while($rows3=$res3->fetch_assoc())
            {
                ...
                <div class='card'>
                    ...
                    <a href='cust_item_det.php?id={$rows3['bid']}'><button class='custom-btn btn'>View Items</button></a>
                </div>
                </div>            
                ";
            }
...
?>
    ...
    <script>
        consoleText(['Item Purchased...', 'Item Purchased...', 'Item Purchased...'], 'text',['rgb(255, 0, 102)','rgb(92, 214, 92)','rgb(191, 128, 255)']);
