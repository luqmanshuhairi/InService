...
<?php 
            ...
            ";
                while($rows=$res->fetch_assoc())
                {
                    ...
                    <div class='card'>
                        ...
                        <a style='float:left' href='cust_item_det.php?id={$rows['bid']}'><button class='custom-btn btn'>View Item</button></a>
        ...
        else
        {
            ...
            <br>
            <a href='search_items.php#recommendations' style='text-decoration:none; font-size:25px'>See Recommendations</a>";
        }
?>
