...
<form action="<?php echo $_SERVER["PHP_SELF"];?>" id="form" enctype = "multipart/form-data" method = "post">
  <div id="wrapper">
    ...
    <label for="name">Name of item</label></div><br>
    <input type="text" name="book_name" required>
    
    <div class="formfield"><br>
    <label for="author">Shop</label></div><br>
    <input type="text"  name="author" required>
    
    <div class="formfield"><br>
    <label for="keywords" style="margin :auto;">Item Description</label></div><br>
