...
<div class="header">
  <div class="shimmer">
  <b style="font-size: 30px; line-height: 30px;"><span class="material-icons">shopping_cart</span>&ensp;InService (Admin Page)</b>
  </div>
</div>
...
<nav class="navi">
  <ul style="margin-top: 0%; padding: 0; list-style-type: none;">
    ...
    <li id="upload" onclick="location.replace('upload_items.php')"><span class="material-icons md-40 md-light">backup</span></li>

    <li id="books" onclick="location.replace('view_items.php')"><span class="material-icons md-40 md-light">book</span></li>
