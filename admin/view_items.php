      ...
      ";
          while($rows=$res->fetch_assoc())
          {
              ...
              <div class='card'>
                  ...
                  <a style='float:left' href='item_det.php?id={$rows['bid']}'><button class='custom-btn btn'>View</button></a>
                  <a style='float:right' href='edit_item.php?id={$rows['bid']}'><button type='submit' class='custom-btn btn2'>Edit</button></a>
                  </div>
              </div>            
              ";
          }
